...
Python is the next programming language you will use in this course.
...
Unlike `nvm`, `pyenv` does not automatically add its startup lines to your
shell startup file.
...
of `openssl` and `readline`. All other users can skip this step.
